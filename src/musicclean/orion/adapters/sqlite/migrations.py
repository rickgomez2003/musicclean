...
MIGRATIONS: tuple[Migration, ...] = (
    Migration(
        ...
        CREATE TABLE orion_artists (id TEXT PRIMARY KEY, name TEXT NOT NULL, sort_name TEXT);
        ...
        CREATE TABLE orion_track_appearances (
            id TEXT PRIMARY KEY, disc_id TEXT NOT NULL, recording_id TEXT NOT NULL,
        ...
        CREATE TABLE orion_audio_files (
            id TEXT PRIMARY KEY, recording_id TEXT, location TEXT NOT NULL UNIQUE,
        ...
        CREATE INDEX idx_orion_track_appearances_disc_id ON orion_track_appearances(disc_id);
        CREATE INDEX idx_orion_track_appearances_recording_id
            ON orion_track_appearances(recording_id);
        CREATE INDEX idx_orion_audio_files_recording_id ON orion_audio_files(recording_id);
        """,
    ),
    Migration(
        2,
        ...
        CREATE INDEX idx_orion_evidence_subject_id ON orion_evidence(subject_id);
        CREATE INDEX idx_orion_evidence_subject_kind ON orion_evidence(subject_id, kind);
        CREATE INDEX idx_orion_evidence_observed_at ON orion_evidence(observed_at);
        """,
    ),
)
...
def migrate(connection: sqlite3.Connection) -> int:
    ...
    for migration in MIGRATIONS:
        ...
        try:
            ...
            connection.execute(
                "INSERT INTO orion_schema_migrations(version, description) VALUES (?, ?)",
