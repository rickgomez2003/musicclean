...
## Routed SLO alert delivery routed-delivery routed-delivery observability

0.6.78 builds and verifies bounded, secret-safe routed-delivery observability evidence before controlled release validation.

## Routed SLO alert delivery routed-delivery routed-delivery SLOs

0.6.79 evaluates and verifies sample-gated, provider-neutral routed-delivery SLO evidence before controlled release validation.

## Routed SLO alert delivery routed-delivery routed-delivery SLO history and trends

0.6.80 builds bounded history, analyzes trends, and verifies secret-safe read-only trend evidence before controlled release validation.

## Routed SLO alert delivery routed-delivery routed-delivery SLO alerting

0.6.81 builds and verifies secret-safe provider-neutral routed-delivery SLO alert evidence before controlled release validation.

## Routed SLO alert delivery routed-delivery routed-delivery SLO escalation and routing

0.6.82 builds and verifies secret-safe provider-neutral logical routing evidence before controlled release validation.

## Routed SLO alert delivery routed-delivery routed-delivery routed delivery

0.6.83 performs route-specific signed HTTPS delivery and verifies the resulting secret-safe receipt before controlled release validation.
